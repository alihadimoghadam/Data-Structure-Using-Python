...
if __name__ == "__main__":
    ...
    print(f"DFS traversal from {start_1}: {dfs(graph_1, start_1)}")
    ...
    print(f"DFS traversal from {start_2}: {dfs(graph_2, start_2)}")
    ...
    print(f"DFS traversal from {start_3}: {dfs(graph_3, start_3)}")
