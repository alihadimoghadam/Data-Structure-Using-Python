from SelectionSort_Algorithm import selection_sort
...
if __name__ == "__main__":
    ...
    sorted_list_1 = selection_sort(unsorted_list_1)
    ...
    sorted_list_2 = selection_sort(unsorted_list_2)
    ...
    sorted_list_3 = selection_sort(unsorted_list_3)
