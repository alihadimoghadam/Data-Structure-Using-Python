from HeapSort_Algorithm import heap_sort
...
if __name__ == "__main__":
    ...
    sorted_list_1 = heap_sort(unsorted_list_1)
    ...
    sorted_list_2 = heap_sort(unsorted_list_2)
    ...
    sorted_list_3 = heap_sort(unsorted_list_3)
